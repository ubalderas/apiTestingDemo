/**
 * This is a file used to test the POST service routes of a given API endpoint. Test cases are generated dynamically by
...
describe("Test Suite for the '" + testService + "' service", function() {
    ...
    let positiveTests = require('./' + testService + '/POST/testCases/positiveTests.json');
    let negativeTests = require('./' + testService + '/POST/testCases/negativeTests.json');
    ...
    positiveTests.forEach(function(testCaseObject) {
        it(testCaseObject.testNumber + " - " + testCaseObject.testDescription, function(done) {
            ...
            let fullTestCasesDirPath = './test/' + testService + '/POST/testRunResults/fullTestCases';
            let actualResponsesDirPath = './test/' + testService + '/POST/testRunResults/actualResponses';
            let expectedResponsePath = './' + testService + '/POST/expectedResponses/' + testCaseObject.testNumber + '.json';
